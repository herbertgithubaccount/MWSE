...
return {
	...
	["enableLogLineNumbers.label"] = "Activer les numéros de lignes de la journalisation ?",
	["enableLogLineNumbers.description"] = "Si cette option est activée, des numéros de lignes seront inclus dans les messages de log générés par les fonctions mwseLoggers Ceci a un léger coût en performances, mais il ne devrait pas vraiment être notable. Les numéros de lignes ne sont calculés que si le niveau de journalisation est suffisamment élevé pour afficher le message journalisé.",
