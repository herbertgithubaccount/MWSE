return {
	...
	arguments = {
		...
		{ name = "sort", type = "boolean|function", optional = true, description = "If true, the returned table will be sorted. If a function is passed, the table will be sorted using the given function." },
	},
	returns = {
